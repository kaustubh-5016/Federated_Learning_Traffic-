...
CLIENT_ID = "client1"
CLIENT_SPACE_NAME = "client1_space"
...
if __name__ == '__main__':
    ...
    client1_space = space_path(CLIENT_SPACE_NAME)
    ...
    model_path = os.path.join(client1_space, 'client1_model.h5')
    weight_path = os.path.join(client1_space, filename)
    if os.path.exists(model_path) and os.path.exists(weight_path):
        ...
        cm.save_weights(os.path.join(client1_space, 'client1_weights.h5'))
        cm.save(model_path)
        ...
        m.save_weights(os.path.join(client1_space, 'client1_weights.h5'))
        m.save(model_path)
        update_and_save_the_learning_curve(client1_space, history, 'loss','LOSAng')
    final_metrics = {
